...
class EventLocation extends Equatable {
  ...
  const EventLocation({required this.name, this.lat, this.lng});
...
class EventDateRange extends Equatable {
  ...
  const EventDateRange({required this.start, this.end});
...
class Event extends Equatable {
  ...
  Map<String, dynamic>? get properties =>
      uniqueData.isNotEmpty ? uniqueData : null;

  /// Legacy aggregateData getter - looks for aggregateData in uniqueData
  Map<String, dynamic>? get aggregateData =>
      uniqueData['aggregateData'] as Map<String, dynamic>?;
  ...
  Duration? get duration =>
      dateRange.hasDuration ? dateRange.end!.difference(dateRange.start) : null;
  ...
  factory Event.fromJson(Map<String, dynamic> json) {
    return Event(
      ...
      dateRange: EventDateRange.fromJson(
        json['dateRange'] as Map<String, dynamic>,
      ),
      uniqueData: Map<String, dynamic>.from(
        json['uniqueData'] as Map<String, dynamic>,
      ),
